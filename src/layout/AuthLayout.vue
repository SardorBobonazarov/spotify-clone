    ...
    <div>
        ...
        <div class="authPart flex justify-center">
            <div class="btns">
                ...
                <div class="or2 mt-12"></div>

                <h2 class="text-center mt-12 font-black">Нет аккаунта?</h2>
                <ButtonVue>
                    <span>Регистрация в Spotify</span>
                </ButtonVue>
...
<script setup>
import ButtonVue from '@/ui-components/Button.vue';
